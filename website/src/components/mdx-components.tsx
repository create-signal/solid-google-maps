...
export const MDXComponents = {
  ...
  h3: (props: ComponentProps<'h3'>) => {
    return <h3 data-toc="" class="font-heading mt-8 scroll-m-20 text-xl font-semibold tracking-tight" {...props} />
  },
  h4: (props: ComponentProps<'h4'>) => {
    return <h4 data-toc="" class="font-heading mt-8 scroll-m-20 text-xl font-semibold tracking-tight" {...props} />
  },
  h5: (props: ComponentProps<'h5'>) => {
    return <h5 data-toc="" class="font-heading mt-8 scroll-m-20 text-xl font-semibold tracking-tight" {...props} />
  },
  h6: (props: ComponentProps<'h6'>) => {
    return <h6 data-toc="" class="font-heading mt-8 scroll-m-20 text-xl font-semibold tracking-tight" {...props} />
  },
  ...
  code: (props: ComponentProps<'code'>) => {
    return (
      <code class="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm group-[&.code]:p-0" {...props} />
    )
  },
  ...
  TabsContent: (props: ComponentProps<typeof TabsContent>) => (
    <TabsContent class="relative [&_h3.font-heading]:text-base [&_h3.font-heading]:font-semibold" {...props} />
  ),
