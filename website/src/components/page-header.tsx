...
export function PageHeaderHeading(props: ComponentProps<'h1'>) {
  ...
  return (
    <h1
      class={cn('text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]', local.class)}
      {...others}
    />
  )
}
...
export function PageHeaderActions(props: ComponentProps<'div'>) {
  const [local, others] = splitProps(props, ['class'])
  return <div class={cn('flex w-full items-center justify-start gap-2 py-2', local.class)} {...others} />
}
