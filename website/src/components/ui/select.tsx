  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        class={cn(
          'relative z-50 min-w-32 overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md animate-in fade-in-80 overflow-y-auto max-h-[var(--kb-popper-content-available-height)]',
          local.class,
        )}
        {...others}
      >
