  ...
  setter(
    [
      ...document
        ...
        .querySelectorAll('h1[data-toc], h2[data-toc], h3[data-toc], h4[data-toc], h5[data-toc], h6[data-toc]'),
    ].map((element) => ({
                ...
                <li class={cn('mt-0 pt-2', section.depth === 3 && 'pl-4')}>
                  <a
                    ...
                    class={cn(
                      ...
                      section.slug === currentSection() ? 'font-medium text-foreground' : 'text-muted-foreground',
                    )}
